...
export const governmentTooltips: Record<string, TooltipContent> = {
  ...
  fiscal_note: {
    category: 'procedures_and_voting',
    title: "Fiscal Note",
    content: "An official estimate of how much a bill would cost (or save) the state if it becomes law. In Kentucky, fiscal notes are prepared by the Governor's Office for Policy and Management (GOPM) in the executive branch, per KRS 6.350. They're requested by legislative leaders or committee chairs."
  },
