...
- Match the breadth of the bill text. Do NOT narrow a broad noun with a descriptor the text does not use (e.g., do not turn "individuals in crisis" into "individuals experiencing a mental health crisis"). Do NOT add adjacent audiences (families, caregivers, coworkers, communities) unless the bill's operative provisions assign them a duty, right, penalty, benefit, or eligibility rule.
- Describe substance only. Do NOT include procedural or status language: current chamber, committee assignment, hearing dates, vote counts, or whether the bill has passed. The site shows current status separately, and summaries are cached.
