...
- [Guides](${origin}/guides): Factual guides to finding your Kentucky state legislators, tracking a bill, how a bill becomes a law in Kentucky, and General Assembly session dates.
