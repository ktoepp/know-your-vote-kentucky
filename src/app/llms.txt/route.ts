...
- [Guides](${origin}/guides): Factual guides to finding your Kentucky state legislators, what state legislators do, tracking a bill, how a bill becomes a law in Kentucky, and General Assembly session dates.
